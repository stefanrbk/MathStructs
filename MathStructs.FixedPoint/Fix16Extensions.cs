...
namespace MathStructs
{
    public static class Fix16Extensions
    {
        ...
        {
            return new Matrix3x3Fix16(span[0], span[1], span[2], span[3], span[4], span[5], span[6], span[7], span[8]);
        }
        ...
        {
            return new Matrix3x3Fix16(array[0], array[1], array[2], array[3], array[4], array[5], array[6], array[7], array[8]);
        }

        public static Matrix4x4Fix16 ToMatrix4x4Fix16(this ReadOnlySpan<int> span)
        {
            return new Matrix4x4Fix16(span[0], span[1], span[2], span[3], span[4], span[5], span[6], span[7], span[8], span[9], span[10], span[11], span[12], span[13], span[14], span[15]);
        }
        ...
        {
            return new Matrix4x4Fix16(array[0], array[1], array[2], array[3], array[4], array[5], array[6], array[7], array[8], array[9], array[10], array[11], array[12], array[13], array[14], array[15]);
        }

        public static Vector2Fix16 ToVector2Fix16(this ReadOnlySpan<int> span)
        {
            return new Vector2Fix16(span[0], span[1]);
        }
        ...
        {
            return new Vector2Fix16(array[0], array[1]);
        }

        public static Vector3Fix16 ToVector3Fix16(this ReadOnlySpan<int> span)
        {
            return new Vector3Fix16(span[0], span[1], span[2]);
        }
        ...
        {
            return new Vector3Fix16(array[0], array[1], array[2]);
        }

        public static Vector4Fix16 ToVector4Fix16(this ReadOnlySpan<int> span)
        {
            return new Vector4Fix16(span[0], span[1], span[2], span[3]);
        }
        ...
        {
            return new Vector4Fix16(array[0], array[1], array[2], array[3]);
        }
    }
}
